...
app.innerHTML=`<main class="lesson-page">
  ...
  <nav class="quick-nav" aria-label="Разделы урока"><a href="#start">Перед началом</a><a href="#theory">Теория</a><a href="#examples">Примеры</a><a href="#practice">Тренировка</a><a href="#homework">Домашняя работа</a>${resourceItems?'<a href="#resources">Материалы</a>':''}<a href="#independent">Самостоятельная</a><a href="#control">Контроль</a></nav>
